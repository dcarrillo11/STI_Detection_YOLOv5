...
public class MainActivity extends AppCompatActivity implements Runnable {
    ...
    private String[] mTestImages = {"test_1.jpg", "test_2.jpg", "test_3.jpg","test_4.jpg", "test_5.JPG", "test_6.JPG", "test_7.JPG"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            BufferedReader br = new BufferedReader(new InputStreamReader(getAssets().open("ETS.txt")));
            String line;
